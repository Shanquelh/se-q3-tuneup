...
__author__ = "Shanquel with study group Sondos and Gabby"
...
def timeit_helper():
    ...
    results = t.repeat(repeat=num_repeats, number=runs_per_repeat)
    time_cost = min(results) / runs_per_repeat
